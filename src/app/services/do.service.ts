...
export class DoService {
  ...
  getDeathfulestsDiseases(year, quantity, tipo_exibicao, sexo = null, raca_cor = null, escolaridade = null, estado = null, capitulo_cb = null, idade_inf = null, idade_sup = null, mes_obito_inf = null, mes_obito_sup = null){
    ...
    (idade_inf ? `&idade_inf=${idade_inf}` : '') + 
    (idade_sup ? `&idade_sup=${idade_sup}` : '') +
    (mes_obito_inf ? `&mes_obito_inf=${mes_obito_inf}` : '') + 
    (mes_obito_sup ? `&mes_obito_sup=${mes_obito_sup}` : '')
    );
  }

  getDeathByState(year, tipo_exibicao, sexo = null, raca_cor = null, escolaridade = null, capitulo_cb = null, idade_inf = null, idade_sup = null, mes_obito_inf = null, mes_obito_sup = null){
  ...
  getDeathByColor(year, tipo_exibicao, sexo = null, escolaridade = null, estado = null, capitulo_cb = null, idade_inf = null, idade_sup = null, mes_obito_inf = null, mes_obito_sup = null){
